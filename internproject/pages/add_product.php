...
$q=" INSERT INTO `products`(`Category`,`Name`, `Price`, `Pic`) VALUES ('$Category','$Name','$Price','$destfile')";
 }
...
<body>
 ...
 <label>Category</label>
    <select class="form-control" name="Category" required="" oninvalid="this.setCustomValidity('Please Select State')" oninput="setCustomValidity('')">
      <option selected>Choose...</option>
      <option>Wishkey</option>
      <option>Beer</option>
      <option>Rum</option>
      <option>Wine</option>
      <option>Vodka</option>
