    ...
    <div class="row align-items-center g-5 py-3 mx-1">
      ...
      <div class="col-10 mx-auto col-lg-4">
        ...
        <form class="p-5 border rounded-3 form-opacity">
            <h5 class="text-center text-white">Forget password</h5>
          <div class="form-floating mb-3">
            <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
            <label for="floatingInput">Email address</label>
          </div>
          <button class="w-100 btn btn-lg btn-primary" type="submit"><a  href="../pages/confirm.php" class="login">Send OTP</a></button>
          <p class="text-center my-2"><a href="../pages/forget.php" class="forget_password">Forget password</a></p>
