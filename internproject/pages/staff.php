  ...
  <body>
      ...
      <body>
          <nav class="navbar bg-dark sticky-top  flex-md-nowrap p-0">
              <a class="navbar-brand col-sm-3 col-md-2 mr-0 text-white " href="#">Admin:
          ...
          <div class="container-fluid">
              <div class="row">
                  ...
                  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 mt-0">
                      <div class="container">
                          <div class="col-lg-12">
                              <button class="btn btn-success my-2"><a href="add_staff.php"
                                      class="text-white text-decoration-none"> Add Emp</a></button>
              ...
              ?>
                                  <tr class="text-center">
                                      ...
                                      <td><button class="btn-danger btn">
                                              <a href="delete_staff.php?id=<?php echo $res['id']; ?>"
                                                  class="text-white text-decoration-none"> Delete
                                              </a> </button></td>
                                      <td><button class="btn-primary btn">
                                              <a href="update_staff.php?id=<?php echo $res['id']; ?>"
